...
if (!createObject('modNamespace',array(
    ...
    'path' => $componentPath.'/core/components/commerce_paymentrequest/',
    'assets_path' => $componentPath.'/assets/components/commerce_paymentrequest/',
),'name', false)) {
    echo "Error creating namespace commerce_paymentrequest.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_paymentrequest.core_path',
    'value' => $componentPath.'/core/components/commerce_paymentrequest/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_paymentrequest',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_paymentrequest.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_paymentrequest.assets_path',
    'value' => $componentPath.'/assets/components/commerce_paymentrequest/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_paymentrequest',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_paymentrequest.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_paymentrequest/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_paymentrequest.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_paymentrequest',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_paymentrequest.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_paymentrequest.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_paymentrequest',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_paymentrequest.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_paymentrequest/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_paymentrequest/src/Modules/';
